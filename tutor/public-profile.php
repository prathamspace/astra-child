...
$user_id = $get_user->ID;
$youtube_link = get_user_meta($user_id, 'youtube_link', true);
...
<div <?php tutor_post_class('tutor-wrap-parent tutor-full-width-student-profile tutor-page-wrap tutor-user-public-profile tutor-user-public-profile-' . $profile_layout . ' ' . $user_identifier); ?>>
	<div class="tutor-container photo-area">
		<div class="cover-area">
			<div style="background-image:url(<?php echo esc_url(tutor_utils()->get_cover_photo_url($user_id)); ?>)">
			</div>
			<div></div>
		</div>
		<div class="pp-area">
			<div class="profile-pic"
				style="background-image:url(<?php echo esc_url(get_avatar_url($user_id, array('size' => 300))); ?>)">
			</div>
			...
			<div class="profile-name tutor-color-white">
				...
				if ($is_instructor) {
					...
					<span>
						<span>
							<?php echo esc_html($complete_count); ?>
						</span>
	...
	<div class="tutor-container" style="overflow:auto">
		...
		<div class="tutor-user-profile-content tutor-d-block tutor-mt-72">
			...
			<div class="content">
				...
				$myId = getId($youtube_link);
				?>
				<iframe width="560" height="315" src="<?php echo "//www.youtube.com/embed/" . $myId ?>"
			...
			<h3>My Calendar</h3>
			<iframe src="https://calendar.google.com/calendar/event?action=TEMPLATE&tmeid=NmVpbGd2NGdlMTc2ZmN1cTM3Y3RuY3U4a3MgcHJhdGhhbUBhcHB6cm9vdC5jb20&tmsrc=pratham%40appzroot.com" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
				<a target="_blank" href="https://calendar.google.com/calendar/event?action=TEMPLATE&amp;tmeid=NmVpbGd2NGdlMTc2ZmN1cTM3Y3RuY3U4a3MgcHJhdGhhbUBhcHB6cm9vdC5jb20&amp;tmsrc=pratham%40appzroot.com"><img border="0" src="https://www.google.com/calendar/images/ext/gc_button1_en.gif"></a>
				<h3>
				<?php esc_html_e('Biography', 'tutor'); ?>
			</h3>
