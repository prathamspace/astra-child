		...
		<form method="post" enctype="multipart/form-data" id="tutor-registration-form">
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="text" name="first_name"
							...
							placeholder="<?php esc_html_e('First Name', 'tutor'); ?>" required autocomplete="given-name">
					</div>
				</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="text" name="last_name"
							...
							placeholder="<?php esc_html_e('Last Name', 'tutor'); ?>" required autocomplete="family-name">
					</div>
				</div>
			...
			<div class="tutor-form-row">
				<div class="tutor-form-col-12">
					<div class="tutor-form-group">
						<label>
							<?php _e('YouTube Link', 'tutor'); ?>
						</label>
						<input type="text" name="youtube_link"
							value="<?php echo tutor_utils()->input_old('youtube_link'); ?>"
							placeholder="<?php _e('YouTube Link', 'tutor'); ?>">
					</div>
				</div>
			</div>
				...
				<div class="tutor-form-col-6">
					<div class="tutor-form-group">
						...
						<input type="password" name="password"
							...
							placeholder="<?php esc_html_e('Password', 'tutor'); ?>" required autocomplete="new-password">
					</div>
				</div>
			...
			<?php if (null !== $tutor_toc_page_link): ?>
				<div class="tutor-mb-24">
					<?php esc_html_e('By signing up, I agree with the website\'s', 'tutor'); ?> <a target="_blank"
						...
						title="<?php esc_attr_e('Terms and Conditions', 'tutor'); ?>">
						<?php esc_html_e('Terms and Conditions', 'tutor'); ?>
					</a>
				</div>
			<?php endif; ?>
			...
			<div>
				<button type="submit" name="tutor_register_instructor_btn" value="register"
					...
					<?php esc_html_e('Register as instructor', 'tutor'); ?>
				</button>
			</div>
