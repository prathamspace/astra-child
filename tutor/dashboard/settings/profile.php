...
$youtube_link = get_user_meta($uid,'youtube_link',true);
...
<div class="tutor-dashboard-setting-profile tutor-dashboard-content-inner">
	...
	<div id="tutor_profile_cover_photo_editor">
		...
		<div id="tutor_cover_area" data-fallback="<?php echo esc_attr($cover_placeholder); ?>"
			...
			<div class="tutor_overlay">
				<button class="tutor_cover_uploader tutor-btn tutor-btn-primary">
					...
					<span>
						<?php echo $profile_photo_id ? esc_html__('Update Cover Photo', 'tutor') : esc_html__('Upload Cover Photo', 'tutor'); ?>
					</span>
				</button>
			</div>
		</div>
		<div id="tutor_photo_meta_area">
			...
			<span>
				<?php esc_html_e('Profile Photo Size', 'tutor'); ?>: <span>
					<?php esc_html_e('200x200', 'tutor'); ?>
				</span>
				<?php esc_html_e('pixels', 'tutor'); ?>
			</span>
			<span>&nbsp;&nbsp;&nbsp;&nbsp;
				<?php esc_html_e('Cover Photo Size', 'tutor'); ?>: <span>
					<?php esc_html_e('700x430', 'tutor'); ?>
				</span>
				<?php esc_html_e('pixels', 'tutor'); ?>
			</span>
			<span class="loader-area">
				<?php esc_html_e('Saving...', 'tutor'); ?>
			</span>
		</div>
		<div id="tutor_profile_area" data-fallback="<?php echo esc_attr($profile_placeholder); ?>"
		...
		<div id="tutor_pp_option">
			...
			<span class="tutor_pp_uploader profile-uploader">
				<i class="profile-upload-icon tutor-icon-image-landscape tutor-mr-4"></i>
				<?php esc_html_e('Upload Photo', 'tutor'); ?>
			</span>
			<span class="tutor_pp_deleter profile-uploader">
				<i class="profile-upload-icon tutor-icon-trash-can-bold tutor-mr-4"></i>
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="tutor-row">
			<div class="tutor-col-12 tutor-col-sm-6 tutor-col-md-12 tutor-col-lg-6 tutor-mb-32">
				...
				<input class="tutor-form-control" type="text" disabled="disabled"
			...
			<div class="tutor-col-12 tutor-col-sm-6 tutor-col-md-12 tutor-col-lg-6 tutor-mb-32">
				...
				<input class="tutor-form-control" type="tel" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" name="phone_number"
					value="<?php echo esc_html(filter_var(get_user_meta($user->ID, 'phone_number', true), FILTER_SANITIZE_NUMBER_INT)); ?>"
					placeholder="<?php esc_attr_e('Phone Number', 'tutor'); ?>">
			</div>
		</div>
		...
		<div class="tutor-row">
			<div class="tutor-col-12 tutor-mb-32">
				...
				<input class="tutor-form-control" type="text" name="tutor_profile_job_title"
		...
		<div class="tutor-row">
			<div class="tutor-col-12 tutor-mb-32">
					...
					<label class="tutor-form-label tutor-color-secondary">
						<?php _e('youtube_link', 'tutor'); ?>
					</label>
					<input type="text" min="1" name="nid" value="<?php echo get_user_meta($user->ID, 'youtube_link', true); ?>"
						placeholder="<?php _e('youtube_link', 'tutor'); ?>">
